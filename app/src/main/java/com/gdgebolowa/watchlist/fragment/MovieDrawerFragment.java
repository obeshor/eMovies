...
import com.gdgebolowa.watchlist.activity.BackupActivity;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_twitter:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/OBAMSerge"));
                startActivity(browserIntent);
                return true;

            case R.id.action_email:
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","yannicksergeobam@gmail.com", null));
